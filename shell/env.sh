...
# The default value assumes a SECURE_LOCAL_PATH setting of ../parentDir/secure_files/ctb
if [ ! -f "/home/vagrant/www/secure_path.env" ]; then
    echo "No secure_path.env found - using default value of /home/vagrant/secure_files/ctb/.env."
    ...
    export ENV_FILE_PATH=/home/vagrant/secure_files/ctb/.env
else
