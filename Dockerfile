...
RUN apt-get -y install unzip libffi-dev libssl-dev libmysqlclient-dev python3-mysqldb python3-dev libpython3-dev libgirepository1.0-dev git ruby g++ curl
...
CMD gunicorn -c gunicorn.conf.py -b :$PORT ctb.wsgi -w 5 -t 70
